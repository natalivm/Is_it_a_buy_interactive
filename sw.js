...
const ASSETS = [
  ...
  BASE + 'stories/mp.html',
  BASE + 'stories/aloy.html',
  BASE + 'stories/fn.html',
  BASE + 'stories/tem.html',
  BASE + 'stories/usar.html',
  BASE + 'stories/uuuu.html',
  ...
  BASE + 'stories/asml.html',
  BASE + 'stories/amd.html',
  BASE + 'stories/lrcx.html',
  ...
  BASE + 'stories/alab.html',
  BASE + 'stories/crdo.html',
  BASE + 'stories/dell.html',
  BASE + 'stories/cohr.html',
  BASE + 'stories/iren.html',
  BASE + 'stories/dram.html',
  BASE + 'stories/nvda.html',
  BASE + 'stories/mrvl.html',
  BASE + 'stories/avgo.html',
  BASE + 'stories/axon.html',
  BASE + 'stories/cien.html',
  BASE + 'stories/lite.html',
  BASE + 'stories/crwv.html',
  BASE + 'stories/tsla.html',
  BASE + 'stories/meta.html',
  BASE + 'stories/panw.html',
