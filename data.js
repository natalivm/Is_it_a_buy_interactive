...
const STOCKS = [
  ...
  },
  {
    ...
    signal: '🔄 NEW CYCLE — long watch, and a different animal from CRWV despite the shared AI-cloud label: NBIS never LOST its daily 200-EMA ($152.35, far below price), daily OBV ≈507M held through the correction, daily RSI 46 is mid-range with the MACD histogram just crossing positive, and Thursday’s +27.13% close reclaimed the 1H 200-EMA ≈$191. The overnight $202.53 cleared the old card’s ≈$196–200 rejection line — the “first credible fade” setup died with it — and parked just under the 50-day EMA $205.37: the same confirmation test MU and DRAM are making at their own 50-days tonight. What caps the rank: the 1H OBV on this window is still negative (≈ −65M, improving but covering-flavored), so demand proof is partial — mid-board until it turns. Frames: 1H pinned (RSI 73, Stoch 93.9) over a daily with fuel (Stoch 22 curling, RSI 46). Plan: NO chase after +27% in a day. Entry: the pullback that HOLDS $188–192 (Thursday’s close + the reclaimed 1H 200-EMA). Stop: a close back under $180 — the old 30-min 200-EMA line whose reclaim started this leg; below it the reclaim failed. Confirmation: a daily CLOSE over the 50-day $205.37. Targets: $205 → $213 (the band lip) → $240 (the upper band / old July shelf). 🚦 Counts only with SMH closing over $547–550.',
    lead: { rank: 10, status: 'wait', entry: 'pullback holds $188–192', stop: '$180 (close)', targets: '$205 → $213 → $240', downside: '+26%', rr: '~5:1', rrStar: true, edge: '🔄 Not another CRWV: NBIS never lost its daily 200-EMA ($152 far below), daily OBV ≈507M held, and Thu’s +27.13% close reclaimed the 1H 200-EMA ≈$191 — overnight $202.53 cleared the old ≈$196–200 rejection line and parked under the 50-day $205.37, the same test MU/DRAM face at their own 50-days; the cap on the rank is the still-negative 1H OBV on this window (≈ −65M, improving): partial demand proof — entry only the pullback that HOLDS $188–192, stop a close under $180 (the line that started the leg), confirmation a daily close over $205.37, targets $205 → $213 → $240; 🚦 counts only with SMH over $547–550' },
    side: 'long', accent: 'indigo',
    date: '2026-07-31',
