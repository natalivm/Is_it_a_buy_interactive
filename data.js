...
const STOCKS = [
  {
    ...
    lead: { rank: 5, entry: '$128–140', stop: '$141', targets: '$110 → $101 → $90', downside: '−33%', rr: '3:1', edge: 'Heaviest OBV distribution in the group', trigger: 'Oversold — wait for the pop into $128–140 to short (stop $141), or short a loss of $110.' },
  ...
  },
  {
    ...
    lead: { rank: 6, entry: '$118–128', stop: '$130', targets: '$104 → $98 → $90', downside: '−27%', rr: '2.8:1', edge: 'Under all MAs with the heaviest OBV distribution', trigger: 'Oversold under the band — wait for the pop into $118–128 to short (stop $130), or a loss of $104.' },
  ...
  },
  {
    ...
    lead: { rank: 1, entry: '$383–393', stop: '$402', targets: '$324 → $300 → $292', downside: '−25%', rr: '~7:1', rrStar: true, edge: 'Defended $345 but a laggard vs SMH — fade the MA stack', trigger: 'Wait for the pop into $383–393 to short (stop $402), or short a loss of $345. Don’t short into support here.' },
    side: 'short', accent: 'blue',
    date: '2026-07-10',
  ...
  },
  {
    ...
    lead: { rank: 3, entry: '$1,880 / >$1,950', stop: '$1,835', targets: '$1,950 → $2,000 → $2,100', downside: '+11%', rr: '~3:1', edge: 'Shallow dip to 9-EMA or breakout — may not revisit lows', trigger: 'Buy a shallow dip to $1,880–1,905 or the breakout > $1,950 (stop $1,835) — may not revisit the lows.' },
  ...
  },
  {
    ...
    lead: { rank: 2, entry: '$895–905 / >$915', stop: '$865', targets: '$934–950 → $1,015 → $1,120', downside: '+24%', rr: '~3:1', edge: 'Shallow dip to 9-EMA or breakout — may not revisit lows', trigger: 'Buy a shallow dip to $895–905 or the breakout > $915 (stop $865). Don’t chase mid-range under the shelf.' },
  ...
  },
  {
    ...
    lead: { rank: 4, entry: '$256–276', stop: '$283', targets: '$226 → $210 → $183', downside: '−31%', rr: '3.2:1', edge: 'Closed red near the low — worst RS, active distribution', trigger: 'Short a bounce into $256–276 (stop $283) or the break of $229. Weakest name — acts soonest.' },
