...
// ASTS, ASML, ALAB, PANW, AMAT and CRDO have no computed ATR(14) on the
...
// ALAB in particular is close (its 08-07 low $329.00 came within $3 of its
// $319–326 zone) and will very likely move up once its ATR exists. Mixing
...
const STOCKS = [
  ...
  },
  {
    ...
    price: '$51.11', change: '📅 $51.11 at the close — $49.39 has flipped from resistance to support, the only level in the cluster that has; supply $52.50–54.00 is 2.7% above',
    signal: '📅 08/07 — THE ONE IN THE GROUP WITH A FLIPPED LEVEL UNDER IT. $51.11 at the close, with supply $52.50–54.00 2.7% above, after a rebound off major $40–42 demand. ⭐ The structural difference from the rest of the cluster: $49.39 was resistance and is now acting as support, so there is a level beneath price proven from above. Daily RSI and OBV are improving; 4H RSI ~68–70 is the least extended of the four. ⚠️ The weekly is NOT repaired — price is still under the $55–56 mid-band. Entry is the $49–50 retest, now 0.36 ATR below; stop $46.00, 1.15 ATR out; targets $52.50 → $55 → $60.',
    lead: { rank: 13, status: 'wait', entry: 'pullback holds $49.00–50.00', stop: '$46.00 (close)', targets: '$52.50 → $55.00 → $60.00', rr: '~3.0:1', edge: '⭐ THE CLUSTER’S BELLWETHER, AND THE ONLY ONE WITH A LEVEL PROVEN FROM ABOVE. $49.39 was resistance and is now support on the 4H — ALOY, USAR and UUUU each have a demand zone beneath them, but none has a flipped level, which is a materially better thing to lean an entry on. ⭐ It is also the least extended of the four at 4H RSI ~68–70 against 73, 76 and 78, and the rebound started from major $40–42 weekly demand that held the whole correction. ⭐ The plan is the $49–50 retest at 0.55 ATR below price, with the $46.00 stop 1.08 ATR from the midpoint and sitting under the top of daily demand $44–46 — Rule B satisfied on a real level rather than a round number. ⚠️ The weekly is not repaired: price is still beneath the $55–56 mid-band, so acceptance over $55–57 is the confirmation that matters, not the $52.50–54 break. ⚠️ ATR is the chart’s visual estimate ($3.00–3.50), not a computed ATR(14). ⚠️ Four names, one piece of news — a fill here consumes the cluster budget. Falsifier: losing $49 opens $48.50–47; daily acceptance under $44 deteriorates the thesis.' },
    side: 'long',
    date: '2026-08-09',
  ...
  },
  {
    ...
    price: '$52.05', change: '📅 $52.05 at the close — weekly, daily and 4H bullish together, the only long here with all three; supply $52.50–54.00 is 0.9% above',
    signal: '📅 08/07 — THE STRONGEST STRUCTURE ON THE BOARD, AT A POOR PRICE. Weekly, daily and 4H are bullish together — the only long here where all three agree — after the weekly mid-band $49.60 was reclaimed and the $49.39 pivot taken back on strong displacement. ⚠️ Monthly is NOT there yet: price is under the $58.30 mid-band. ⚠️ And location is poor: supply $52.50–54.00 is 0.9% up with the 4H RSI ~73.6. Entry is the $49–50 retest, 0.67 ATR below; stop $45.00; targets $52.50 → $55.50 → $58.50. ⚠️ Computed ATR(14) is $3.04, not the $4–5 estimated, so that stop is 1.48 ATR out — wider than intended.',
    lead: { rank: 19, status: 'wait', entry: 'pullback holds $49.00–50.00', stop: '$45.00 (close)', targets: '$52.50 → $55.50 → $58.50', rr: '~2.0:1', edge: '⭐ THE ONLY LONG ON THIS BOARD WITH WEEKLY, DAILY AND 4H POINTING THE SAME WAY — which is why the board’s own key puts it at the top of the long block on conviction 3.5, ahead of everything else. The weekly mid-band $49.60 is reclaimed after another defence of $41–42, the daily reversal took back the $49.39 pivot on strong displacement, and the 4H broke the $45–47 base with rising OBV. ⚠️ The monthly has not joined: price is still under the $58.30 mid-band, so this is a repaired weekly inside an unresolved HTF consolidation, not a new secular leg. ⚠️ Location is the problem, as with every new name this week: supply $52.50–54.00 begins 1% above with the 4H RSI at 73.6, and an ~8–10% ATR means an ordinary session covers four to five dollars. So the entry is the $49–50 flip zone at 0.44 ATR below price, with the $45.00 stop on the top of secondary demand $43.50–45.00. ⚠️ Computed ATR(14) is $3.04, not the $4–5 estimated, so that stop is 1.48 ATR from the midpoint rather than the 1.00 it was sized for — too far rather than too near. It stays because $45.00 is a real level, but the trade-off is stated: a 1.00-ATR stop at $46.46 would re-rate the R:R from ~2.0:1 to ~2.9:1 while sitting just under 4H demand $46.50–47.50. ⚠️ R:R ~2.0:1 is the most modest of the new names, and that is the honest price of a stop wide enough to survive this ATR. ⭐ Different sector from ALOY/MP/USAR/UUUU — this is the diversifier, not a fifth leg of the same bet. ⚠️ Verify the $49.39 pivot: MP’s read quotes the same level to the cent. Falsifier: daily acceptance under $46.50.' },
    side: 'long',
    date: '2026-08-09',
