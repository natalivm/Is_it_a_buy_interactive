...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 24, status: 'wait', entry: 'pullback holds $49.00–50.00', stop: '$46.46 (close)', targets: '$52.50 → $55.50 → $58.50', rr: '~2.9:1', edge: '⭐ THE CHART CONFIRMS THE ANCHOR AND IMPROVES IT. $49.39 is a genuine drawn level on TEM, so the coincidence flagged against MP is resolved: TEM’s level is real, MP’s was spurious and has been retracted. Better still, the $49–50 zone turns out to rest on three independent references: the $49.39 pivot, the 50-EMA $50.08 at the top of the zone, and the BB mid-band $48.70 immediately beneath it. That is a stronger anchor than Rule A asks for. ⚠️ Two things in the original read were wrong and both matter. Daily RSI is 56.29 — mid-range, not stretched — so the ~73.6 belongs to the 4H alone; the case for waiting is location, not exhaustion, and a fill at $49–50 is a normal pullback rather than a capitulation. And price is ABOVE the daily BB mid-band $48.70, not below it: the "$55.8 declining mid-band" was the 200-EMA $55.54, which sits inside the $55.50–57.00 zone and is precisely why acceptance THERE, not over $52.50–54, is the confirmation that counts. ⭐ Daily MACD hist is +0.49 and has just turned positive, with OBV 345.7m. ⭐ THE STOP IS NOW $46.46 — the alternative this card costed out last session, taken. ATR(14) $3.04 put the old $45.00 at 1.48 ATR, too FAR rather than too near, and the move re-rates R:R ~2.0:1 → ~2.9:1 while cutting risk from the entry midpoint 9.1% → 6.1%. ⚠️ The trade-off, stated outright: $45.00 was the deeper reference — the top of daily demand $43.50–45.00 — and $46.46 leans on the 4H/daily band $46.50–47.50 instead, so this is a tighter leash on a nearer level, and a dip through $46.50 that would once have been survivable now ends the trade. ⚠️ It also sits EXACTLY on the 1.00 ATR floor, so any ATR expansion puts it under Rule B and the level has to be re-read rather than left. Falsifier: daily acceptance under $46.50.' },
    side: 'long',
    date: '2026-08-10',
