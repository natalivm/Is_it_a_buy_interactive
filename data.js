...
const STOCKS = [
  ...
  },
  {
    ...
    signal: 'The board’s barometer — the break is confirmed on the close, daily AND weekly. The mid-day roll never bounced: SMH closed Friday at $561.19 (−3.27%, −$18.98) near the lows, and after-hours is flat ($561.20) — no recovery bid. That’s a decisive DAILY close below the $580 / 50-EMA line and under the 21-day mid-BB ($576.05), plus a bearish WEEKLY close back below the weekly 9-EMA ($582.65) — the strongest form of the breakdown the deck flagged, not an intraday wick. Big-picture the uptrend is still intact (weekly MACD positive, price far above the weekly 50-EMA $431 / daily 200-EMA $467), but near-term structure is broken and there’s room to fall: weekly RSI is only ~58 (nowhere near oversold), so this can keep bleeding even while the 1H is short-term oversold (RSI 35.98). Stance: the confirmed loss of $580 keeps the board’s short fades ARMED and active (NBIS / AAOI / SNDK / MU / COHR / TER); a long is not the trade. Support/target ladder: $547–550 → $535 swing-low → the fat $510–518 confluence (daily lower BB $517.82 now converging with the $510–515 weekly magnet: 0.5 fib + 21-week MA + open gap). Only a reclaim back over $580 with breadth negates the fade.',
    edge: 'The board’s barometer — the break is confirmed on the close, daily AND weekly: SMH closed $561.19 (−3.27%) near the lows, after-hours flat, below the $580 / 50-EMA line, the 21-day mid-BB ($576) and the weekly 9-EMA ($582.65); weekly RSI only ~58 (not oversold → room to fall) even as the 1H is oversold — the confirmed loss keeps the board’s fades armed toward $547–550 → $535 → the $510–518 confluence (daily lower BB + weekly magnet), only a reclaim over $580 negates',
    side: 'short', accent: 'red',
    date: '2026-07-24',
