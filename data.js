...
const STOCKS = [
  ...
  },
  {
    ...
    price: '$51.80', change: '📅 $51.80 — $49.39 has flipped from resistance to support, the only level in the cluster that has; pressing supply $52.50–54.00',
    signal: '📅 08/07 — THE ONE IN THE GROUP WITH A FLIPPED LEVEL UNDER IT. $51.80, pressing supply $52.50–54.00, after a rebound off major $40–42 demand. ⭐ The structural difference from the rest of the cluster: $49.39 was resistance and is now acting as support, so there is a level beneath price that has actually been proven from above. Daily RSI and OBV are improving; 4H RSI ~68–70 is the least extended of the four. ⚠️ The weekly is NOT repaired — price is still under the $55–56 mid-band. Entry is the $49–50 retest, not $52+; stop $46.00, 1.08 ATR out; targets $52.50 → $55 → $60. ⚠️ One position with ALOY, USAR and UUUU.',
