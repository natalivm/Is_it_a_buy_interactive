...
const MARKET = {
  ...
  markets: [
    ...
    },
    {
      ...
      note: '🌙 Pre-open 7/31: the gate is trading — overnight $550.15 sits ON $547–550 after Korea reversed hard (SK Hynix +27.8%, Samsung +24.8%) on MSFT’s capex beat. Gaps propose, closes ratify: a daily CLOSE above breaks the group’s daily downtrend (shorts off board-wide, long cycle confirmed); a fade back under $547 traps the chasers; under $535 re-arms shorts. Thursday’s completed bar left fuel — daily Stoch 14.5 off the floor, RSI 42, mid-range — while every 1H in the cohort is pinned: buy held retests, never the open. Gates above by fib+MA confluence: $552 (0.382) → $557–560 → $572–576 (50-day + mid-band, the real fight) → $580 (end of fade-mode) → $594–600 (0.618 + the wall). NVDA >$194 in regular hours = the general joins. Tonight is also the weekly close.',
    },
  ],
  vol: [
    {
