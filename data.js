...
const STOCKS = [
  ...
  },
  {
    ...
    price: '$567.06', change: '−2.26% intraday · lost $580 / 50-EMA + $572 · FADES RE-ARMED',
    signal: 'The board’s barometer — the line broke mid-day, the fades are back on. SMH held $580 pre-market but rolled hard after the open: −2.26% to $567.06 by late morning, slicing straight through the $580 / 50-EMA line AND $572 — the decisive loss with follow-through the deck flagged as the fade trigger. Price is now below the entire 1H EMA stack (9/50/200 = $575/$579/$585) and under the lower Bollinger ($569), so the “holding the fulcrum” read is gone — the roll-over resumed and confirmed. Momentum is bearish and stretched: 1H RSI 35.98, Stochastics 13.56/18.89 (oversold, so a reflex bounce is live), daily MACD negative. This is price catching down to the murky internals — McClellan −26.68 and falling, Market Tide −$582M outflow — breadth led, price followed. Stance: the $580 loss RE-ARMS the board’s short fades (NBIS / AAOI / SNDK / MU / COHR / TER); a long is not the trade. Next supports $565–568 (here) → $547–550 lower daily BB → $535 swing-low → the $510–515 magnet on continuation; only a reclaim back over $580 with breadth negates the fade.',
    edge: 'The board’s barometer — the $580 line broke mid-day: SMH held it pre-market then rolled −2.26% to $567.06, slicing $580 / 50-EMA and $572, now under the whole 1H EMA stack ($575/$579/$585) and the lower BB ($569); 1H RSI 35.98 / Stoch 13.56 oversold (reflex bounce live) but structure broken and price caught down to breadth — the decisive loss re-arms the board’s short fades, next $547–550 → $535 → the $510–515 magnet, only a reclaim over $580 negates',
    side: 'short', accent: 'red',
    date: '2026-07-24',
