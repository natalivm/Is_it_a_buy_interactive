...
const STOCKS = [
  ...
  },
  {
    ...
    signal: 'Memory bellwether — the break extended into the close. After the $905 trigger, MU closed $820.53 (−8.85%), now well below both the $886 shelf and the daily 21-mid-BB ($868) — the two levels that had held the chop since June — and driving straight toward T1 $800 (a hair above). That is ≈ +9% for the short from the $905 entry, with an air pocket below. AH $825.60 (+0.62%) — a shallow bounce, no reclaim. Structure: below the whole MA stack and stretched under the lower Bollinger — a parabola unwinding, with the daily 50-EMA ($714) and 200-EMA (≈ $590) below. The real test is the 50-day $714. Confirmation is now in: a daily close that held under $868; only a reclaim back over $886 would be a fakeout. Stance: leg down live and extending → T1 $800 → daily 50-day $714 → weekly 21-MA $665 → 🕳️ $505; only a close back over $955 / $1,005 ends it. The bellwether that dragged the group up is now leading it down.',
    lead: { rank: 1, status: 'live', entry: '$905 filled', stop: '$1,005', targets: '$800 → $714 → $665 → $505', downside: '−11%', tail: '−44%', rr: '~4:1', edge: 'Memory bellwether — the break extended into the close: MU closed $820.53 (−8.85%), well below the $886 shelf and the daily mid-BB ($868) that held the chop since June, driving toward T1 $800 (≈ +9% for the short from $905, air pocket below); AH $825.60 a shallow bounce with no reclaim, below the whole MA stack — a parabola unwinding toward the 50-day $714 → weekly 21-MA $665 → 🕳️ $505, the daily close held under $868, only a reclaim over $886 is a fakeout' },
