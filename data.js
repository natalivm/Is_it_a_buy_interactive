...
const STOCKS = [
  ...
  },
  {
    ...
    signal: '📅 THE PLAN AS WRITTEN IS DEAD; THE STRUCTURE IS NOT. Those are two different statements and this card owes both. What happened: MU gapped to $919.65, ran $930.88 — and collapsed to $818.00, closing $823.03 (−5.90%), five dollars off the low. The card’s stop was “a 1H close back under $853” and the DAY closed 30 dollars beneath it, so the old $874–890 entry never filled and the plan is void by its own rule. ⭐ THE GATE IS WHY THAT COST NOTHING: this card required an SMH close over $547–550, SMH closed $540.53, so the long was never taken. A fill in the old zone would have been stopped the same session. Zero realised loss on a −5.90% reversal — the gate discipline paid for itself in cash, not in theory. Now the part that separates MU from SNDK, which printed the same candle and lost its rank for it: MU HELD its structure. The 50-day ≈$778.74 was never threatened, price is far above the daily 200-EMA ≈$588.83, and ⭐ the WEEKLY RSI closed 56.26 — still above the midline and the healthiest weekly in the DRAM/NAND complex (SNDK ≈49, DRAM unreliable), above the weekly teal ≈$730.49 and far above the 50-week ≈$545.25. SNDK broke its stop AND its structural premise; MU broke only the plan. Hence a re-drawn zone rather than a demotion off the board. ⚠️ Be honest about the weakness: closing $5 off the low is bad tape, the 9-EMA ≈$892.61 is lost, and daily Stoch 22.14 / RSI 43.58 put MU in the washed-out DRAM/NAND cohort rather than with the HDD names that held. ⚠️ And the long frame carries the board’s worst reading: monthly Stoch 89.08 with the monthly MACD histogram flipping RED for the first time, July closing −24% from its open ($1,082 → $823). Monthly MACD is still POSITIVE, so decelerating, not reversing. RE-DRAWN PLAN: entry is the retest that HOLDS $800–823 — Friday’s close down to the round number, sitting on top of the 50-day that actually held. Stop: a daily CLOSE under $778 (the 50-day — the real line, not the old one). Confirmation: a daily close back over the lost 9-EMA ≈$892. Targets: $892 → $930 (Friday’s high) → $996–1,000. 🚦 Counts only with SMH closing over $547–550.',
    lead: { rank: 8, status: 'wait', entry: 'retest holds $800–823', stop: '$778 (daily close)', targets: '$892 → $930 → $1,000', downside: '+21%', rr: '~5:1', rrStar: true, edge: '📅 The plan is dead; the structure is not — both are owed. Gapped $919.65, ran $930.88, collapsed to $818.00 and closed $823.03 (−5.90%) five dollars off the low: the “$853 1H close” stop broke by 30 dollars, so the old $874–890 entry is void. ⭐ And it cost NOTHING — the gate required an SMH close over $547–550, SMH closed $540.53, so the long was never taken; a fill would have stopped the same session. What separates MU from SNDK, which printed the same candle: MU held its STRUCTURE — the 50-day ≈$778.74 never threatened, and weekly RSI 56.26 is still above the midline, the healthiest in the DRAM/NAND complex. SNDK broke its stop AND its premise; MU broke only its plan — hence a re-drawn zone, not a demotion off the board. ⚠️ Honest weakness: closed $5 off the low, 9-EMA ≈$892.61 lost, daily Stoch 22.14 puts it in the washed-out cohort not with the HDD names; monthly Stoch 89.08 is the board’s worst with the histogram just red and July −24% from its open — though monthly MACD stays POSITIVE (decelerating, not reversing). Re-drawn: entry holds $800–823 on the 50-day, stop a daily close under $778, confirmation a close back over $892, targets $892 → $930 → $1,000; 🚦 SMH $540.53 — unfilled' },
