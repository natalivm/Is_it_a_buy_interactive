...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 4, status: 'live', entry: '$38.90 filled', stop: '$42', targets: '$34 → $30 → $27', downside: '−13%', tail: '−31%', rr: '~3:1', edge: 'Flipped short — T2 smashed on a −13.62% collapse: IREN closed $29.31, clean through T2 $30 (weekly support, banked one day after T1 $34), AH $29.20 — ≈ +25% for the short from $38.90, only 🕳️ T3 $27 left; 1H OBV NEGATIVE (−32.6M), RSI 22.01, Stoch 9.43 pinned with the $30.87/$34.31/$38.05 stack far overhead — don’t chase $29, add zone pulled down to $31–34 (1H 9→50-EMA), bank/trail toward $27; the ≈$2.8B AI-cloud catalyst the squeeze risk, a reclaim of $41.70 repairs the long' },
    side: 'short', accent: 'red',
    date: '2026-07-29',
  ...
  //
  // ── Re-rated 2026-07-29 (close) ── same solidity rule, applied to the
  // post-close board: FRESH confirmed breaks with full room + tight
  // invalidation top the table; names sitting AT/through their final
  // targets slide to the bank zone (deep-in-the-money ≠ best fresh
  // setup); contingencies stay last. New order:
  //   1 LITE (200-day break confirmed TODAY, filled, full room $500→$419)
  //   2 SNDK (trend-mode, no bounce, clear magnets $958→$880)
  //   3 AAOI (own weakness — OBV negative, room to $58)
  //   4 IREN (T2 smashed, room to $27, OBV negative)
  //   5 TER  (re-armed TODAY, full plan $308→$292→$280 remaining, chop risk)
  //   6 NVDA (filled TODAY but 200-day undercut-reclaim = verdict pending)
  //   7 MU · 8 NBIS · 9 COHR · 10 CRDO (deep in the money, sitting AT
  //     their majors — bank/trail zone, fresh entry poor)
  //   11 WDC (all targets banked; extension contingent on <$450)
  //   12 ALAB (ALL targets banked to the dollar — runner to $231 only)
  //   13 CRWV (wait · META binary tonight) · 14 GLW · 15 BE (booked).
  // ───────────────────────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    lead: { rank: 7, status: 'live', entry: '$905 filled', stop: '$1,005', targets: '$800 → $714 → $665 → $505', downside: '−11%', tail: '−44%', rr: '~4:1', edge: 'Memory leader — hardest red day of the slide, AH pressing T2: MU closed $739.00 (−9.94%) and slid after hours to $718.38, right onto the 50-day $714 — the real test of the parabola (≈ +18% for the short from $905 at the close, ≈ +21% AH); 1H tape pure distribution (OBV bleeding to 203M, Stoch pinned 8.99, the $778/$835/$905 stack capping every lift) — don’t press into the tag, bank/trail into $714, add a bounce into $778–835 ($868–886 the bigger), only a reclaim over $886 is a fakeout' },
    side: 'short', accent: 'cyan',
    date: '2026-07-29',
