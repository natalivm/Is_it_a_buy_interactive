...
const STOCKS = [
  ...
  // NBIS broke the coil low; COHR through T1+T2 to the 50-week). Completed wins
  // with nothing left are DEAD LAST (GLW ~+21% at 12, BE ~+26% at 13 — all targets
  // banked, no fresh short; both still surface in the booked strip). TER (11) ranks
  // just above them: its short is still live but under an earnings contingency (a
  // beat popped it +13% AH over the stop — verdict waits for tomorrow's cash), so it
  // sits above the two finished trades but below the working shorts. STX/BE beats
  // also reversed AH but had already banked their targets. Ranks now 1–13, contiguous.
  // ───────────────────────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    signal: 'Worst OBV in the group — the $89 gate broke on the close. INTC closed $86.30 (−5.86%), a decisive break UNDER the $89 gate (weekly 21-MA) the card flagged — the break that opens the air pocket. AH $86.79 (+0.57%). Structure is broken: price under the whole daily MA stack, worst OBV on the board. The daily air pocket runs to the rising 200-EMA ≈ $75, then the unfilled $66 gap. Near-term deeply oversold (1H RSI 42.27, Stoch 26.93, MACD −1.94; daily Stoch 14.25), so a reflex bounce is due — a bounce back into $89–92 (the broken gate = new lid) is the cleaner short entry, not a chase of the low. Confirmation is now in: the cash close held under $89. Stance: gate broken, air pocket open toward the 200-EMA ≈ $75 / the $66 gap; a reclaim back over $92 stalls it, and $98–102 negates.',
    edge: 'Worst OBV in the group — the $89 gate broke on the close: INTC closed $86.30 (−5.86%), a decisive break under the $89 gate (weekly 21-MA) that opens the air pocket toward the daily 200-EMA ≈ $75 / the $66 gap; under the whole daily stack, deeply oversold (1H RSI 42.27, Stoch 26.93; daily Stoch 14.25) so a bounce into $89–92 (broken gate = new lid) is the cleaner short, the cash close held under $89 — a reclaim over $92 stalls it, $98–102 negates',
  ...
  },
  {
    ...
    signal: 'Memory bellwether — the break extended into the close. After the $905 trigger, MU closed $820.53 (−8.85%), now well below both the $886 shelf and the daily 21-mid-BB ($868) — the two levels that had held the chop since June — and driving straight toward T1 $800 (a hair above). That is ≈ +9% for the short from the $905 entry, with clean air below. AH $825.60 (+0.62%) — a shallow bounce, no reclaim. Structure: below the whole MA stack and stretched under the lower Bollinger — a parabola unwinding, with the daily 50-EMA ($714) and 200-EMA (≈ $590) below. The real test is the 50-day $714. Confirmation is now in: a daily close that held under $868; only a reclaim back over $886 would be a fakeout. Stance: leg down live and extending → T1 $800 → daily 50-day $714 → weekly 21-MA $665 → 🕳️ $505; only a close back over $955 / $1,005 ends it. The bellwether that dragged the group up is now leading it down.',
    lead: { rank: 1, status: 'live', entry: '$905 filled', stop: '$1,005', targets: '$800 → $714 → $665 → $505', downside: '−11%', tail: '−44%', rr: '~4:1', edge: 'Memory bellwether — the break extended into the close: MU closed $820.53 (−8.85%), well below the $886 shelf and the daily mid-BB ($868) that held the chop since June, driving toward T1 $800 (≈ +9% for the short from $905, clean air below); AH $825.60 a shallow bounce with no reclaim, below the whole MA stack — a parabola unwinding toward the 50-day $714 → weekly 21-MA $665 → 🕳️ $505, the cash close held under $868, only a reclaim over $886 is a fakeout' },
  ...
  },
  {
    ...
    price: '$126.01', change: '✅ TARGETS REACHED · booked ~+21% · close −12.10% $126.01 (earnings) · AH $126.39 · dead-cat bounce',
  ...
  },
  {
    ...
    price: '$166.84', change: '✅ TARGETS REACHED · booked ~+26% · close −11.34% $166.84 · ⚠️ EARNINGS BEAT · AH +10.88% $185 (high $191)',
