...
const SETUPS = [
  ...
  // ── Apr 30 setups ────────────────────────────────────────────────────────
  {
    id: 'spy-2026-04-30', symbol: 'SPY', direction: 'Long',
    entryTrigger: 715.21, stop: null, target: null,
    setupType: 'Pullback', tier: null,
    addedDate: '2026-04-30',
    notes: 'Gap fill resistance at $715.21 · upswing trend line acts as further resistance if gap is breached · morning sell-off then bid to upside · gap fill hit Apr 30 (H=719.79)',
    status: 'watching', triggeredDate: '2026-04-30', closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'uso-2026-04-30', symbol: 'USO', direction: 'Short',
    entryTrigger: 151.26, stop: null, target: null,
    setupType: 'Reversal', tier: null,
    addedDate: '2026-04-30',
    notes: 'Strong rejection from historical gap (level from 2015) at $151.26 · 4–5% move to the downside expected from this area',
    status: 'watching', triggeredDate: null, closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'googl-2026-04-30', symbol: 'GOOGL', direction: 'Short',
    entryTrigger: 388.36, stop: 400.00, target: null,
    setupType: 'Reversal', tier: 'setup',
    addedDate: '2026-04-30',
    notes: 'Retesting broken upswing trend line (scene of the crime) · solid rejection/short at $388.36 · aggressive DCA from $380 · psych resistance $400',
    status: 'watching', triggeredDate: null, closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'amd-2026-04-30', symbol: 'AMD', direction: 'Short',
    entryTrigger: 350.32, stop: null, target: null,
    setupType: 'Pullback', tier: null,
    addedDate: '2026-04-30',
    notes: 'Day trade short at $350.32 · if consolidates here targets shift to $375 then $400 · upswing trend line keeping stock buoyant · resistance hit Apr 30 (H=354.96), fell to L=332.60',
    status: 'watching', triggeredDate: '2026-04-30', closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'nvda-2026-04-30', symbol: 'NVDA', direction: 'Long',
    entryTrigger: 194.92, stop: null, target: null,
    setupType: 'Pullback', tier: 'setup',
    addedDate: '2026-04-30',
    notes: 'Dropped 6% on GPU sales news · day trade long on pierce of $195 at $194.92 · resistance $212.19 · close below trend line → scene of the crime short at $212',
    status: 'watching', triggeredDate: null, closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'amzn-2026-04-30', symbol: 'AMZN', direction: 'Short',
    entryTrigger: 258.74, stop: null, target: 237.00,
    setupType: 'Reversal', tier: null,
    addedDate: '2026-04-30',
    notes: 'Hit upper end of parallel channel ~$275 and fell 6% · below $258.74 targets channel midline $237.00 · gap fill day trade at $239.76 · broke below $258.74 Apr 30 (L=256.16)',
    status: 'watching', triggeredDate: '2026-04-30', closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'msft-long-2026-04-30', symbol: 'MSFT', direction: 'Long',
    entryTrigger: 393.11, stop: null, target: null,
    setupType: 'Pullback', tier: 'setup',
    addedDate: '2026-04-30',
    notes: 'Earnings broke below downswing trend line · day trade long entry $393.11 · swing target $366.82, further support $344.70',
    status: 'watching', triggeredDate: null, closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'wdc-2026-04-30', symbol: 'WDC', direction: 'Short',
    entryTrigger: 435.15, stop: 441.99, target: null,
    setupType: 'Reversal', tier: null,
    addedDate: '2026-04-30',
    notes: 'Topping tail on 10M vol · short at 78.6% Fib $435.15 or $438.55 · stop 15-min close above $441.99 · avoid into earnings unless extreme short at $500 · Fib touched Apr 30 (H=438.86), C=434.52',
    status: 'watching', triggeredDate: '2026-04-30', closedDate: null, closePrice: null, closeReason: null,
  },
  {
    id: 'intc-2026-04-30', symbol: 'INTC', direction: 'Short',
    entryTrigger: 100.00, stop: null, target: 54.73,
    setupType: 'Reversal', tier: null,
    addedDate: '2026-04-30',
    notes: 'Up 136% in a month — severely overextended · major resistance at $100 psych level · long-term support $54.73 · NOTE: $100 broke out on May 5 — prediction missed',
