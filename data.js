...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 5, status: 'wait', entry: '$190–198', stop: '$207', targets: '$180 → $167 → $152', downside: '−19%', rr: '~3:1', edge: 'Lost the 50-day and already bouncing into the $190–198 retest — defined break-and-retest, daily rolling over' },
    side: 'short', accent: 'blue',
    date: '2026-07-15',
  ...
  },
  {
    ...
    lead: { rank: 4, status: 'wait', entry: '$256–280', stop: '$296', targets: '$226 → $210 → $183', downside: '−32%', rr: '3:1', edge: 'Established downtrend under the fast MAs — trend-continuation re-short into the MA stack, −32% downside' },
    side: 'short', accent: 'amber',
    date: '2026-07-15',
