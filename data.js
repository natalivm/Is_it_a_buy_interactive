...
const STOCKS = [
  ...
  },
  {
    ...
    signal: '📅 CLOSE — STILL UNRANKED, AND THE MISS IS THE INSTRUCTIVE PART: the return condition is a reclaim of $834.93 on a CLOSE; MU traded $836.62 and closed $829.50, $5.43 under — reached and not held, and the rule does not bend for a high. The re-drawn plan survived its test: $800–823 traded, the $778 close-basis stop was breached intraday at $770.15 and reclaimed. Friday’s HELD/BROKE cohort split inverted in one session, so the ranks built on it come down — MU closed on the green side of the inversion, the first evidence in its favour since the plan broke. Weekly cross FRAGILE at 14.6% of MACD, but Monday-only bars decide nothing until Friday.',
  ...
  },
  {
    ...
    signal: '🕐 PM 08/06 5:57 ET — THE LEG IS PLAYING OUT, AND THE FIRST PIECE IS BANKED. PM $1,228.46 (−9.04%) is below the entire $1,287–1,346 zone, T1 $1,187 just 3.4% away. 📒 The owner shorted the round-trip top near $1,400 and closed the same session — AH cannot be sold and a bought-back dip was the risk — so the first leg is realised (exit to be recorded); the written plan itself stayed unfilled. Next leg by the rules: no chasing −9% pre-market into T1 — the entry is a REJECTION off the broken band, $1,251 (4H upper BB) → $1,287 (broken floor · weekly 21-MA), anchored at the next refresh. The $1,000 view runs into the rising daily 200-EMA $958. A close over $1,287 kills it.',
    lead: { rank: 18, status: 'wait', entry: 'fade the rejection in $1,287–1,346', stop: '$1,360 (dead >$1,346 close)', targets: '$1,187 → $1,050 → $1,000', rr: '~7:1', edge: '📒 FIRST LEG BANKED BY THE OWNER from ≈$1,400, closed the same session; the written plan stayed unfilled. Next entry only on a rejection at the broken $1,251–1,287 band off completed frames — T1 $1,187 is 3.4% from the PM print, no chase. A close back over $1,287 kills the continuation.' },
    side: 'short', accent: 'red',
    date: '2026-08-06', alert: true,
