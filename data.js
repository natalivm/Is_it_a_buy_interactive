...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 7, entry: '$560–592', stop: '$606', targets: '$500 → $465 → $440', downside: '−22%', rr: '2.4:1', edge: 'Bounce into the MA stack = re-short' },
    side: 'short',
    date: '2026-07-08',
  ...
  },
  {
    ...
    lead: { rank: 8, entry: '$1,733–1,850', stop: '$1,900', targets: '$1,544 → $1,420 → $1,394', downside: '−22%', rr: '~3:1', edge: 'Fade the 200-day rejection — but a strong close' },
  ...
  },
  {
    ...
    lead: { rank: 6, entry: '$850–875', stop: '$900', targets: '$795 → $778 → $648', downside: '−24%', rr: '2.5:1', edge: 'Fade the bounce into supply' },
