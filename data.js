...
const STOCKS = [
  ...
  // clocked as pre-market to match, so the frame is stated rather than implied.
  {
    ...
    price: '$172.01', change: '📅 CLOSE $172.01 (+10.32%) — the board’s biggest session, and the plan sat it out: the $141–143 zone is 20.3% below this close and all three targets traded on an order that never filled',
    signal: '📅 CLOSE 08/07 — EVERY TARGET TRADED AND NOTHING WAS FILLED. Closed $172.01 (+10.32%) on a $159.97–172.41 range, so $150, $157 and $168 all printed — on a plan whose entry is $141–143, now 20.3% BELOW price. Nothing is taggable: a target traded on an unfilled plan is not a realised result, it is a forgone one. ⚠️ The zone is the problem, not the read. It was drawn under the 200-EMA $141.65 when price was there; price is now 17% above the 9-EMA $147.62 and has not looked back. ⭐ Frame: RSI 72.83, Stoch 87.44, daily hist +4.79 four bars and expanding, weekly hist +2.62 JUST TURNED green. Falsifier for re-entry: this needs a new zone, not a wait.',
    lead: { rank: 23, status: 'wait', entry: 'pullback holds $141–143', stop: '$134 (close)', targets: '$150 → $157 → $168', rr: '~3.3:1', edge: '⚠️ THE MOST EXPENSIVE KIND OF RIGHT: the direction was called and the entry was priced where price never returned. $150 → $157 → $168 all traded on 08-07 while the order sat at $141–143, 20.3% under the close. ⭐ Nothing is tagged and that is correct — `tagged` presupposes a fill, so this counts as forgone, not booked. ⚠️ The anchor is what failed: $141–143 was pinned to the 200-EMA $141.65 as price left it, and a level price is walking away from is a memory of one bar, not support. Price now sits 16.5% over the 9-EMA $147.62 and 27.5% over the 50-EMA $134.89 — there is no pullback structure between here and the old zone to buy. ⭐ The frame is genuinely strong: weekly hist +2.62 just turned green, daily +4.79 four bars and expanding, RSI 72.83. Falsifier: this plan needs re-drawing to a reachable confluence or retiring — waiting at $141–143 is not a plan.' },
    side: 'long',
    date: '2026-08-09',
  ...
  },
  {
    ...
    price: '$165.68', change: '📅 CLOSE $165.68 (+5.41%) — pushed above the 50-EMA $169.14 intraday to $170.43 and closed back under it, so the average is still overhead',
    signal: '📅 CLOSE 08/07 — A STRONG SESSION THAT STOPPED AT THE 50-EMA. Closed $165.68 (+5.41%), high $170.43 — through the 50-EMA $169.14 and this month’s prior range — but the close came back under the average, so it is still overhead resistance rather than reclaimed support. ⭐ Daily hist +3.33, four bars and expanding; weekly hist −7.33 JUST TURNED to contracting; price 8% over the 9-EMA $153.50. ⚠️ Against the file: the $141–147 short zone, drawn where the last rejection printed and logged as blown, is now 13% below price — the anchor lesson holds. Next reference on a reclaim: the weekly 9-EMA $167.52, then $170.43.',
  ...
  },
  {
    ...
    price: '$218.72', change: '📅 CLOSE $218.72 (+3.89%) — +12.7% from the $194 fill with T2 $216 tagged and T3 $230 now 5.2% away',
    signal: '📅 CLOSE 08/07 — WORKING, WITH T3 IN RANGE. Closed $218.72 (+3.89%), high $221.87, +12.7% from the $194 fill. T2 $216 is tagged and T3 $230 is 5.2% overhead — the high did not reach it, so nothing is added. ⭐ Daily hist +4.76, four bars and expanding, price back over the 9-EMA $204.68 and the 50-EMA $213.91; weekly hist −6.19 is contracting and JUST TURNED green. ⚠️ The session low $205.52 was a 7.4% intraday range, so the $200 stop is nearer in practice than the 8.6% gap suggests — one range like that reaches it. Stop $200 (close).',
    lead: { rank: 3, status: 'live', entry: 'filled $194', stop: '$200 (close)', targets: '$205 → $216 → $230', rr: '~6:1', tagged: '$216', edge: '⭐ THE CLEANEST HELD LONG: +12.7% from $194, T2 $216 tagged, and 08-07 closed +3.89% with the daily hist +4.76 four bars positive and expanding. Price is back above both the 9-EMA $204.68 and the 50-EMA $213.91, and the weekly hist −6.19 JUST TURNED green — the frames are aligning rather than arguing. ⭐ T3 $230 is 5.2% away and the $221.87 high did not reach it, so it is a live objective rather than a forgone one. ⚠️ The one number to respect is the range: $205.52 to $221.87 is 7.4% in a session, which puts the $200 stop closer than its 8.6% distance implies — a single day like 08-07 covers most of that ground. ⚠️ The stop is close-basis, which is what kept STX and DELL alive on this same session, so leave it there rather than tightening into the noise. Falsifier: a daily close under $200.' },
    side: 'long', accent: 'blue',
    date: '2026-08-09',
  ...
  // the whole basis for ranking them above names that were removed.
  {
    ...
    price: '$483.36', change: '📅 CLOSE $483.36 (−1.21%) — the $476.06 low missed the $449–476 zone top by SIX CENTS, and T1 $486 traded earlier in the same session',
    signal: '📅 CLOSE 08/07 — MISSED THE FILL BY SIX CENTS. Low $476.06 against a zone top of $476 — the order did not fill by $0.06, and the same session printed $498.82, through T1 $486. Closed $483.36 (−1.21%). ⚠️ This is the sharpest argument on the board against treating a zone edge as exact: a plan that was right about the level produced nothing because of six cents. ⚠️ The frame is the weakest of the waiting longs — daily hist −2.26, negative FORTY-FOUR bars, price under the 9-EMA $489.57 and 50-EMA $487.19, weekly hist −4.31 JUST TURNED red. Stop $421, targets $515 → $574.',
    lead: { rank: 15, status: 'wait', entry: 'pullback holds $449–476', stop: '$421 (close)', targets: '$486 → $515 → $574', rr: '~2.7:1', edge: '⚠️ SIX CENTS. The session low was $476.06 and the zone top is $476 — the order missed by $0.06, and price then ran to $498.82, through T1 $486, before closing $483.36. Nothing filled, nothing tagged. ⚠️ Resist the obvious fix: widening the zone to catch it turns a level into a tolerance band, which is how you end up short of the top of a real rejection or long above real support. The zone was right; the outcome was luck, and one session of it. ⚠️ What genuinely argues against the trade is the frame, which is the poorest of the waiting longs: daily hist −2.26 and negative FORTY-FOUR bars, price under both the 9-EMA $489.57 and the 50-EMA $487.19, and the weekly hist −4.31 JUST TURNED red. ⭐ The zone itself is anchored on the 50-EMA and this month’s base, two references, and price is sitting on it. Falsifier: a weekly close under $455.30.' },
    side: 'long', accent: 'amber',
    date: '2026-08-09',
