...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 1, status: 'wait', entry: '$342–356 bounce', stop: '$366', targets: '$324 → $300 → $292', downside: '−16%', rr: '~3.5:1', edge: 'Clean shelf-break confirmed and following through — fell straight to T1 without the retest; refreshed re-short zone at the broken VWAP/9-EMA, R:R now compressed since most of the first leg is done' },
    side: 'short', accent: 'blue',
    date: '2026-07-16',
