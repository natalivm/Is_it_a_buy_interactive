...
const STOCKS = [
  ...
  },
  {
    ...
    signal: '📅 CLOSE 08/07 — SECOND RETRACTION, SAME ERROR: $41.28 IS TEM’S TOO. MP’s own daily chart puts this recovery’s base BELOW $40, at the lower band $38.38 — not at $41.28. That band is replaced by $38.00–40.00; $31–33 is deleted (below the window, nothing anchors it). $52.50–54.00 SURVIVES: the upper band $53.01 sits inside it and today’s high $53.47 was rejected there. ⚠️ So the $42.00 stop no longer sits on demand — it sits in the void above the base. Kept at 1.05 ATR with the trade-off stated: the structural stop is a close under $38.00, 2.36 ATR, R:R ~4.6:1 → ~2.1:1. Entry $44.00–46.40 is untouched — 9-EMA $46.37 + BB mid $45.70. Falsifier: daily acceptance under $44.',
    lead: { rank: 28, status: 'wait', entry: 'pullback holds $44.00–46.40', stop: '$42.00 (close)', targets: '$52.50 → $55.17 → $60.00', rr: '~4.6:1', edge: '🚨 THE SAME ERROR, A SECOND TIME — AND THAT IS THE FINDING. $49.39 was TEM’s level carried onto MP. The coherence pass then flagged that the retraction was incomplete: MP and TEM still shared three byte-identical bands and the same $41.28 low. MP’s own daily chart now splits them three ways. $40.50–42.00 “the $41.28 low the recovery started from” is FALSE — the early-August base is visibly under the $40.00 gridline, down at the lower band $38.38. So $41.28 is TEM’s line in the sand, carried across exactly as $49.39 was. $31–33 is removed: it lies below the chart’s window and nothing identifies it. ⭐ There IS an unexplained axis pill reading 31.28 — and it is deliberately NOT used to rescue the band. It is not one of the three Bollinger values (53.01 / 45.70 / 38.38, symmetric about the mid), so it is an unidentified number that happens to land inside the range, which is the $49.39 mistake in its most tempting form. $52.50–54.00 is CONFIRMED instead of merely suspected: the upper band $53.01 is inside it and the high $53.47 traded in and was rejected — two names at $51 and $52 sharing supply there is not a coincidence needing explanation. ⚠️ What it costs the plan: the $42.00 stop’s justification is void — it sits in the void ABOVE the real base, not on demand. It still passes Rule B on volatility (1.05 ATR from the $45.20 midpoint) so it is KEPT, with the alternative quoted: a daily close under $38.00 is 2.36 ATR and cuts R:R from ~4.6:1 to ~2.1:1. The entry survives untouched — the 9-EMA $46.37 and BB mid $45.70 were verified references from the start, which is the whole argument for naming them.' },
    side: 'long',
    date: '2026-08-09',
