...
const STOCKS = [
  ...
  },
  {
    ...
    price: '$578.56', change: '−0.28% pre-mkt · $580.17 Jul 23 close · HOLDING $580 / 50-EMA',
    signal: 'The board’s barometer — the roll-over stalled and the reclaim is holding. The fade’s “one-day trap” call didn’t play: after tagging $584 Tuesday, SMH pushed to a second close over $580 (~$587 Wednesday), then Thursday rolled −1.15% to close $580.17 — but only back TO the line, not through it. Friday pre-market it’s stabilizing, not extending: −0.28% to $578.56, coiling right on the 50-EMA ($579.74) / 9-EMA ($581.53) rather than losing it. So the drop toward $572→$510 the deck was tracking stalled — the barometer is consolidating at the fulcrum, well above its rising daily 200-EMA ($467). Momentum is balanced, not bearish: daily RSI 46.6 / 1H RSI ~49 sit right on the 50 pivot, daily MACD still negative (≈ −4.63) but Stochastics are curling up (≈ 48 off the low). Stance: no-man’s-land AT the line — the bounce stalled under the $594–600 wall / 21-day mid-BB ($597) so it’s not a confirmed all-clear, but the fade is only the base case if $578/$572 breaks with follow-through. Watch the cash open — a hold of $578 / 50-EMA keeps the barometer neutral-to-firm and the fades on ice; a decisive loss re-arms them; a reclaim of $586→$594 with breadth opens the up-case.',
    edge: 'The board’s barometer — the roll-over stalled right at the line: Thursday’s −1.15% fade held the $580 / 50-EMA ($579.74) and Friday pre-market SMH is stabilizing (−0.28% to $578.56, coiling on the 9/50-EMA stack), well above the rising daily 200-EMA ($467); daily MACD still negative but Stochastics curling up — no-man’s-land at the fulcrum, the fades sit on ice while $578 holds and only re-arm on a decisive loss, a reclaim of $586→$594 opens the up-case',
    side: 'short', accent: 'red',
    date: '2026-07-24',
