...
const STOCKS = [
  ...
  },
  {
    ...
    edge: 'Bottom-watch for a long — MRVL closed $174.47 (−7.77%, AH $175.86), into the $172–178 first starter-buy zone; deeply oversold (daily RSI 35.03 / Stoch 17.41; 1H Stoch 36.81) under the whole stack — start a small buy at the $172–178 shelf here, load the main $150–160 flush where the daily 200-EMA ≈$155 + weekly 50-EMA ≈$146 line up, stop under $142; a reclaim of $185 → $198–200 confirms the bottom toward $200 → $220 → $245, a weekly close under $146 breaks the trend (off the ranked board, a watch)',
