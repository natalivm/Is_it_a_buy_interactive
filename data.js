...
const STOCKS = [
  ...
  // `lead`; all three are watch-only until a pullback fills.
  {
    ...
    price: '$359.49', change: '📅 CLOSE $359.49 (−0.87%) — full daily stack intact and a 12-month high $376.98 made this month; monthly hist +16.75 is four bars positive and EXPANDING · a ranking candidate, unranked for now',
    signal: '📅 CLOSE 08/06 — ONE OF THE TWO CLEANEST UPTRENDS ON THE BOARD. Closed $359.49 (−0.87%), holding a full daily stack — price over the 9-EMA $346.54, 50-EMA $309.90 and 200-EMA $237.68 — with this month’s $376.98 high also the 12-month high. ⭐ Monthly hist +16.75 is four bars positive and EXPANDING and the weekly is positive too; that combination exists on three cards here, none of them semis. ⚠️ Monthly RSI 75.18 is extended, so this is a pullback entry if it becomes one — the 9-EMA / month-low band at $330–347 is where the references sit. Unranked pending a plan.',
    side: 'long', accent: 'amber',
    date: '2026-08-07',
  ...
  },
  {
    ...
    price: '$207.39', change: '📅 CLOSE $207.39 (−1.18%) — ⭐ the only card with daily, weekly AND monthly all rising; 12-month high $219.35 made this month · a ranking candidate, unranked for now',
    signal: '📅 CLOSE 08/06 — ⭐ THE ONLY THREE-FRAME UPTREND ON THE BOARD. Closed $207.39 (−1.18%) with daily, weekly and monthly ALL rising — no other card can say that today. Weekly hist +4.05 is sixteen bars positive and EXPANDING, monthly +8.20 four bars and expanding, and the full daily stack sits beneath price (9-EMA $199.33, 50-EMA $181.03, 200-EMA $142.90). This month’s $219.35 is the 12-month high. ⚠️ Monthly RSI 75.10 is extended and the references for an entry sit at $194.81–199.33 (mid-band + 9-EMA). ⚠️ Expiry attached, as required: this claim ages in one bar — its falsifier is the weekly histogram ceasing to expand.',
    side: 'long', accent: 'red',
    date: '2026-08-07',
