...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 20, status: 'live', entry: 'fade the rejection in $252–266', stop: '$272 (dead >$266 close)', targets: '$240 → $230 → $218', downside: '−16%', rr: '~3:1', edge: '🔄 The fourth rejection-only short, parked in its own card’s zone: overnight $260 sits INSIDE the old $252–266 re-load band under the daily 200-EMA $266.37 (“the slide’s first structural repair” line) with the 1H 200-EMA $278.34 beyond; the laggard tape — weakest daily RSI of the night (36.6), daily OBV drifting down, 1H OBV ≈27.1M unchanged since Wednesday afternoon through +12% and an up overnight: no money flow arrived — and the optics pair says it plainly: LITE reclaimed its 200-day, COHR has not; entry only a rejection in $252–266 + a 1H close back under $240 → $240 → $230 → $218, stop $272, DEAD on a daily close over $266.37; SMH gate + $266 = dropped' },
