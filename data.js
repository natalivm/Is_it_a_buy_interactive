...
const STOCKS = [
  ...
  //   3. ⚠️ THE MONTHLY-HISTOGRAM CLAIM IS UNVERIFIED AND WRONG ON MU. This
  //      refresh asserted across several cards that "the monthly MACD histogram
  //      flipped RED for the first time". Recomputed, MU's monthly histogram is
  //      +84.02 — POSITIVE and green. MU's card is corrected; the same sentence
  //      still stands UNVERIFIED on AMAT, STX, WDC, LITE, SNDK, INTC, ALAB and
  //      CRDO, and must be re-checked against computed data before it is
  //      trusted or repeated. Treat it as suspect, not as evidence.
