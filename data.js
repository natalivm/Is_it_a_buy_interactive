...
const MARKET = {
  ...
  note: 'One-line read: a covering rally that has NOT broadened. QQQ +2.90% orderly — holds $678–680 all session, RSI 53, parked at the ≈$681 lower high. SMH +6.43% flat since 10:00, stalled at $540; $547–550 untested. The move is memory: MU +15.7%, SNDK +23%, both Stoch 90+ and stretched on 15-min. Internals split: VIX 17.80 ✅ broke the <18 confirm, Market Tide +$924M, 70% >200DMA — but McClellan stalls at zero and put/call is 1.16: vol and flow confirm, breadth does not. Bands unchanged — SMH Repairing, QQQ Rolling over. Bank shorts into strength, chase nothing. AMZN tonight.',
};
...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 10, status: 'live', entry: 'break <$610 filled', stop: '⛔ $665 HIT', targets: '$500 → $419', closed: '$665', downside: '−18%', tail: '−31%', rr: '~2.5:1', edge: '⛔ STOPPED OUT — the squeeze’s first outright loss (realized ≈ −9% at $665), and the lesson is position age: this short was filled YESTERDAY at the freshest break on the board, so the cohort squeeze hit it with zero cushion while the weeks-old shorts kept partial gains; LITE $683.17 (+13.42% at 2:26 ET) went through the $640–660 add zone and the $665 stop in one leg and is back ABOVE the broken 200-day ≈$610 — the trigger negated — now above the 1H upper band $681.77 pressing the 1H 50-EMA $687.01, with ≈$721–732 (old full-repair zone) and the 1H 200-EMA $751.01 above; NO trade: do not revenge-short — the only re-arm is a fresh daily CLOSE back under $610 (until then the $500 → $419 map is dormant), and a close over ≈$732 repairs the daily outright; peer COHR made the same break and is still on 7/29 data — stale, not unaffected' },
    side: 'short',
    date: '2026-07-30',
