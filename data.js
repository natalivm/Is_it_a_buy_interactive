...
const STOCKS = [
  ...
  },
  {
    ...
    lead: { rank: 4, entry: '$560–592', stop: '$606', targets: '$500 → $465 → $440', downside: '−22%', rr: '2.4:1', edge: 'Bounce into the MA stack = re-short' },
    side: 'short',
    date: '2026-07-08',
  ...
  },
  {
    ...
    lead: { rank: 1, entry: '$112–116', stop: '$124', targets: '$101 → $94 → $86', downside: '−25%', tail: '−39%', rr: '2.6:1', edge: 'Cleanest break; nearly at T1' },
  ...
  },
  {
    ...
    lead: { rank: 3, entry: '$967–1,015', stop: '$1,050', targets: '$860 → $810 → $675', downside: '−31%', rr: '2.1:1', edge: 'Most extended → furthest to fall' },
  ...
  },
  {
    ...
    lead: { rank: 6, entry: '$383–393', stop: '$402', targets: '$318 → $300 → $260', downside: '−32%', rr: '~9:1', rrStar: true, edge: 'Blow-off bouncing off the 50-day' },
    side: 'short', accent: 'blue',
    date: '2026-07-08',
  ...
  },
  {
    ...
    lead: { rank: 7, entry: '$193–205', stop: '$217', targets: '$180 → $167 → $150', downside: '−25%', rr: '2.4:1', edge: 'Capped by the 200-EMA; fade the bounce' },
    side: 'short', accent: 'blue',
    date: '2026-07-08',
  ...
  },
  {
    ...
    lead: { rank: 9, entry: '$1,733–1,850', stop: '$1,900', targets: '$1,544 → $1,420 → $1,394', downside: '−22%', rr: '~3:1', edge: 'Fade the 200-day rejection — but a strong close' },
  ...
  },
  {
    ...
    price: '$838.36', change: '+1.30% · Jul 8',
    signal: 'Oversold bounce to fade — +1.3% to $838, climbing back toward the 4h 200-EMA $869 / $850–875 supply after the rejection; still bear-crossed under the MA stack; fade the bounce into $850–875, T1 $795 → $778 → $648; lose $818 accelerates; reclaim $900 negates',
    lead: { rank: 5, entry: '$850–875', stop: '$900', targets: '$795 → $778 → $648', downside: '−24%', rr: '2.5:1', edge: 'Fade the bounce into supply' },
  ...
  },
  {
    ...
    lead: { rank: 8, entry: '$215–225', stop: '$233', targets: '$192 → $174 → $157', downside: '−29%', rr: '4:1', edge: 'Bounced back into the re-short zone' },
